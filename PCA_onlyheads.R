...
data = primary_data
samples_data = read.table("/Users/danielle/Desktop/2018_04_LSP/samples/samples_onlyheads.txt", header=F, check.names=F, fill=T)
...
larval_colors = c('#595959FF','#595959FF','#595959FF')
adult_colors= c('#595959FF')
sample_colors = c(adult_colors,adult_colors,larval_colors)
female_symbols = c(1)
male_symbols = c(2)
sample_symbols = c(female_symbols,male_symbols,larval_symbols)
print(sample_colors)
