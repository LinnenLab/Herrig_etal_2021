...
data = primary_data
samples_data = read.table("/Users/danielle/Desktop/2018_04_LSP/samples/samples_onlybodies.txt", header=F, check.names=F, fill=T)
...
adult_colors= c('#4b984b','#a6a6a6FF','#1f497dFF','#9474BDFF','#b12334FF','#DD7E00')
larval_symbols = c(0,4,5)
female_symbols = c(1,1,1,1,1,1)
male_symbols = c(2,2,2,2,2,2)
larval_colors = c('#FFCF1AFF','#FFCF1AFF','#FFCF1AFF')
adult_colors= c('#4b984b','#1f497dFF','#9474BDFF','#b12334FF','#DD7E00')
sample_colors = c(adult_colors,adult_colors,larval_colors)
sample_symbols = c(female_symbols,male_symbols,larval_symbols,larval_symbols)
print(sample_colors)
