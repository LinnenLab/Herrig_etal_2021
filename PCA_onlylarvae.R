...
data = primary_data
samples_data = read.table("/Users/danielle/Desktop/2018_04_LSP/samples/samples_onlylarvae.txt", header=F, check.names=F, fill=T)
...
sample_colors = c(larval_colors)
sample_symbols = c(larval_symbols,larval_symbols)
print(sample_colors)
